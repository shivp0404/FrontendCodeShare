    ...
    <div className="flex flex-col bg-black w-full min-h-screen p-6 text-white">
      ...
      >
        ...
        <textarea
          ...
          value={formData.code}
          onChange={handlechange}
          className="flex-grow bg-black text-gray-100 border border-gray-800 rounded-lg p-4 font-mono text-sm placeholder-gray-600 focus:outline-none focus:ring-1 focus:ring-purple-900 h-96  resize-none"
